...
<ul>
    ...
    <div id="data">
    	...
    	<p id="bt">
    		<a href="served.php">Served Orders</a>
    	</p>
...
while($res = mysqli_fetch_array($result)){
	...
	<td>".$res["bloodgrp"]."</td>
	<td>".$res["units"]."</td>
	<td><a href = 'uporders.php?oid=$res[order_id]& bid=$res[bank_id]& hid=$res[hosp_id]& bg=$res[bloodgrp]& un=$res[units]'>UPDATE</td>
		<td><a href = 'delorders.php?oid=$res[order_id]'>DELETE</td></tr>
	";
}
