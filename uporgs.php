...
$sql = "SELECT * from organization_list WHERE org_id={$org_id}";
...
<ul>
    ...
    <div id="data">
    	<center><div>
    		<h1>Update:</h1>
	<form method="post" action="uporgs1.php">
	<table>
		<tr>
			<td width="200px" height="50px">Organization Name:</td>
			<input type="hidden" name="org_id" value="<?php echo $res['org_id'] ?>">
			<td width="200px" height="50px"><input type="text" value="<?php echo $res['org_name'] ?>" name="org_name"></td>
		</tr>
		<tr>
