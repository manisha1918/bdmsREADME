...
$sql = "SELECT * from hospital_list WHERE hosp_id={$h_id}";
...
<ul>
    ...
    <div id="data">
    	<center><div>
    		<h1>Update:</h1>
	<form method="post" action="uphospitals1.php">
	<table>
		<tr>
			<td width="200px" height="50px">Hospital Name:</td>
			<input type="hidden" name="hosp_id" value="<?php echo $res['hosp_id'] ?>">
			<td width="200px" height="50px"><input type="text" value="<?php echo $res['hosp_name'] ?>" name="hosp_name"></td>
		</tr>
		<tr>
